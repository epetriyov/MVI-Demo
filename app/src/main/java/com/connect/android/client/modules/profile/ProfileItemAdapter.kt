...
class ProfileItemAdapter(private val layoutInflater: LayoutInflater) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfileItemViewHolder {
        return ProfileItemViewHolder(layoutInflater.inflate(R.layout.adt_profile_item, parent, false))
    }

    override fun onBindViewHolder(holderRecommendationItem: ProfileItemViewHolder, position: Int) {
        holderRecommendationItem.bindView(getItem(position))
    }
}
